#!/bin/bash
#PBS -q auto_free
#PBS -N 1pa_2pa_tail_18_25
#PBS -l walltime=48:00:00
#PBS -l select=1:ncpus=4:mpiprocs=1:ompthreads=4:ngpus=1:mem=250gb
#PBS -o /scratch/e1583490/logs/pbs_output_d.log
#PBS -e /scratch/e1583490/logs/pbs_error_d.log
#PBS -k oed

set -euo pipefail

TIMESTAMP=$(date +%Y%m%d_%H%M%S)
LOG_DIR=/scratch/e1583490/SuperKludege_Optimizations/IMRI_TAIL_1PA_with_Phase_4/logs_D_${TIMESTAMP}
mkdir -p "$LOG_DIR"
